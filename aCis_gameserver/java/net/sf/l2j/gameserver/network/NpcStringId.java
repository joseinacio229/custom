...
public final class NpcStringId
{
	...
	@NpcString(id = 1900178, message = "%s![PT] Bem vindo! Area de farm drop itens encantados")
	public static NpcStringId ID_1900178;
	
	@NpcString(id = 1900179, message = "%s![EN] Welcome! Farm drop area enchanted items")
	public static NpcStringId ID_1900179;	
